...
main: $(SRC)/main.c $(SRC)/routing_table.c $(SRC)/topology.c $(SRC)/route_cfg_parser.c $(SRC)/dynamic_routing.c $(SRC)/packets.c
	gcc $(GCC_OPTIONS) $(SRC)/main.c $(SRC)/routing_table.c $(SRC)/topology.c $(SRC)/dynamic_routing.c $(SRC)/route_cfg_parser.c $(SRC)/packets.c -o $(BIN)/main -lpthread
